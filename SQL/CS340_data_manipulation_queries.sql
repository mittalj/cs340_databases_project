...
SELECT t.first_name, t.last_name, t.birth_date, t.gender, t.date_employed, t.capacity, l.branch_name, GROUP_CONCAT(q.qual_name) from trainers t
...
VALUES (LAST_INSERT_ID(), :qual_id_dropdown_input);
COMMIT;
...
-- Add Qualification --
INSERT INTO qualifications (qual_name)
VALUES (:qual_name_input);
...
DELETE FROM trainer_qualifications WHERE trainer_id = :trainer_ID_selected_from_trainer_list AND qual_id = :trainer_qualification_ID_selected_from_qualification_list;

-- Locations Dropdown --
SELECT location_id AS branch_name from locations

-- Qualifications Dropdown --
Select qual_id AS qual_name from qualifications

-- Personal Trainer Dropdown --
Select trainer_id AS first_name, last_name from trainers 

-- Programs Dropdown --
Select program_id AS program_name from programs 
