...
SELECT m.first_name, m.last_name, m.birth_date, m.gender, m.weight, p.program_name, l.branch_name, CONCAT_WS(' ', t.first_name, t.last_name), m.member_id FROM members m
...
SELECT branch_name, address_line1, address_line2, city, state, zip, location_id from locations;

-- Add Member --
INSERT INTO members (first_name, last_name, birth_date, gender, weight, program_id, preferred_location, trainer_id)
VALUES (:first_name_input, :last_name_input, :birth_date_input, :gender_input, :weight_input, :program_id_input, :location_dropdown_input, :trainer_id_dropdown_input);
...
-- Update Members --
UPDATE members SET first_name = :first_name_input, last_name= :last_name_input, birth_date = :birth_date_input, gender= :gender_input, weight = :weight_input, program_id = :program_id_input, preferred_location = :location_dropdown_input, trainer_id = :trainer_id_dropdown_input, 
WHERE member_id= :member_ID_selected_from_members_list;
...
-- Update Locations --
UPDATE locations SET branch_name = :branch_name_input, address_line1= :address_line1_input, address_line2 = :address_line2_input, city= :city_input, state = :state_input, zip = :zip_input WHERE location_id= :location_id_input;

--Delete member--
DELETE FROM members WHERE member_id = :member_ID_selected_from_member_list;
